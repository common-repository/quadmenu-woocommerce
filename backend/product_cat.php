...
class QuadMenu_Nav_Menu_Product_Cat extends QuadMenu_Settings {

    public function __construct() {

        add_filter('quadmenu_edit_nav_menu_walker', array($this, 'add_nav_menu_item_product_cat'), 10, 3);
    }

    function add_nav_menu_item_product_cat($walker_class_name, $menu_id = null, $menu_obj = null, $menu_items = null) {

        if (!empty($menu_obj->menu_item_parent) && !empty($menu_obj->quadmenu) && $menu_obj->quadmenu === 'product_cat') {
            return __CLASS__;
        }
    ...
    public function product_cat($menu_obj, $menu_id = 0) {
...
new QuadMenu_Nav_Menu_Product_Cat();